...
const DailyResponseChart = ({ param }) => {
  ...
  const getCountTicketByUser = async () => {
    try {
      const response = await customAxios.get(`tickets/response-time-department/${param.departmentID}`, { params: {start_date: param.start_date, end_date: param.end_date, granularity:'daily'} });
